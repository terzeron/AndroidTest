...
package net.terzeron.keyframetest;

// Need the following import to get access to the app resources, since this
// class is in a sub-package.
import com.example.ch26_4.R;
    ...
    public class MyAnimationView extends View 
        ...
        private void createAnimation() {
            if (yxBouncer == null) {
                ...
                Keyframe kf1 = Keyframe.ofFloat(.3f,ballX+100f);
                Keyframe kf2 = Keyframe.ofFloat(0.7f, ballX-100f);
                Keyframe kf3 = Keyframe.ofFloat(1f,ballX + 50f);
                PropertyValuesHolder pvhX = PropertyValuesHolder
                        .ofKeyframe("x", kf0, kf1, kf2, kf3);
                //수정 끝
