package net.terzeron.contentprovidertest;

import net.terzeron.contentprovidertest.R;
...
public class MainActivity extends Activity {
	...
	private void deleteDicData() {
		...
		int mRowsDeleted = 0;
		mRowsDeleted = getContentResolver().delete(UserDictionary.Words.CONTENT_URI, mSelectionClause, mSelectionArgs);
	}
