...
package net.terzeron.mediaplayertest;

import java.io.File;

import com.example.ch24_2.R;
		...
		try {
			...
			case LOCAL_AUDIO:
				...
				String sdPath = Environment.getExternalStorageDirectory()
						.getAbsolutePath();
				path = sdPath + File.separator + "DCIM/Video/cannon.wma";
				Log.d("file", path);
				if (path == "") {
					Toast.makeText(MediaPlayerAudioActivity.this,
							"파일 위치를 지정하도록 액티비" + "티를 수정하세요.", Toast.LENGTH_LONG)
							.show();
				}
